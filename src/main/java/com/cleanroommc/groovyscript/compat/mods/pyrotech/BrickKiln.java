...
public class BrickKiln extends ForgeRegistryWrapper<BrickKilnRecipe> {
    ...
    public Collection<BrickKilnRecipe> add(String name, IIngredient input, ItemStack output, int burnTime, float failureChance, ItemStack... failureOutput) {
    ...
    public static class RecipeBuilder extends AbstractRecipeBuilder<BrickKilnRecipe> {
        ...
        @Override
        public @NotNull List<BrickKilnRecipe> register() {
