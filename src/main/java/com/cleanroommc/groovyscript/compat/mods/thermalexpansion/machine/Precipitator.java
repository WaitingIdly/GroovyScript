...
public class Precipitator extends VirtualizedRegistry<PrecipitatorRecipe> {
    ...
    public Collection<PrecipitatorRecipe> add(int energy, ItemStack output, int water) {
    ...
    public static class RecipeBuilder extends AbstractRecipeBuilder<PrecipitatorRecipe> {
        ...
        @Property(defaultValue = "PrecipitatorManager.DEFAULT_ENERGY", comp = @Comp(gt = 0), value = "groovyscript.wiki.thermalexpansion.energy.value")
        ...
        public @NotNull Collection<PrecipitatorRecipe> register() {
